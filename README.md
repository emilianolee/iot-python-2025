...
- 파이썬 응용
    ...
    - 파이썬 GUI 라이브러리
        1. PyQt, PySide : 파이썬에서 쓰는 최고의 GUI 라이브러리. Qt라는 C/C++ 사용할 때 GUI라이브러리를 Python용으로 변경
            - 화려한 UI구성
            - 코딩 다양성
            - 조금 어렵다(파이썬 코드와 분리가능)
...
https://github.com/user-attachments/assets/6df19862-c83f-4a6b-ae98-645d6167e784
...
- 파이썬 응용
    ...
    - 토이프로젝트
        ...
        - 공의 y축 방향 계산 방법 : $x = r \cdot \sin \theta$


<img src="./image/py004-2.gif" width="700" height="450">
