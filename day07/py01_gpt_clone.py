...
# 6. 제미나이 API용 구성
genai.configure(api_key='AIzaSyDd0Faaw5EU-kqVE9x8koMimr4DgEk5n70')  # 신청한 API키 
...
# 12. 아이콘 변경
# ./image/경로는 삭제
root.iconbitmap('bot.ico')  # pyinstaller로 설치할 땐 해당폴더에 복사하고 
...
# 8. 입력창에서 엔터를 치면 keypress 이벤트처리함수
...
textResult.tag_configure('ai', font=boldFont, foreground='limegreen')   #89F336
