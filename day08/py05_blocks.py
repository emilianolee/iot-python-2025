...
class Block:
    ...
    def move(self): # 볼 무브
        # 볼이 움직이는 x축 값을 계속 계산하려면 x는 dir 값을 radian으로 변환 후 코사인처리
        self.rect.centerx += math.cos(math.radians(self.dir)) * self.speed
        # 볼이 움직이는 y축 값을 계속 계산하려면 y는 dir 값을 radian으로 변환 후 사인처리
...
def main():
    ...
    while True:
            ...
            if event.type == QUIT: 
                ...
                if event.key == K_LEFT:
                    if PADDLE.rect.centerx < 50:
                        ...
                        PADDLE.rect.centerx -= 10   # 패달은 좌우로만 이동  
        ...
        if is_game_start == False:
        ...
        else:   # 게임시작 후 블록 다 그리고 볼이 움직이게 처리, 바도 움직이도록 처리
            ...
            elif BALL.rect.centery < 10: ## 게임화면 천장에 부딪히며 반사
                BALL.dir = -BALL.dir
