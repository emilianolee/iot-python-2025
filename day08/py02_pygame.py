...
def main():
    ...
    message1 = myfont.render('Este es mi mensaje', True, (255,150,255))
    message2 = myfont.render('Este es PyGame', False, (255,150,255))
    while True:
        ...
        circle(Surface,(255,112,10), (280, 160), 30, 10)
